...
import { GenericLookupFieldComponent } from '../generic-lookup-field/generic-lookup-field.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule, GenericLookupFieldComponent],
